...
export const PROVIDER_PRESETS = [
  ...
  {
    id: "openrouter",
    label: "OpenRouter (breadth gateway)",
  ...
  },
  {
    ...
    openAiCompatible: true,
    keyRequired: true,
    note: "Also the foundry cloud fine-tune lane + Code Interpreter (untrusted-exec). Chat base is OpenAI-compatible.",
  },
  {
    id: "moonshot",
    label: "Moonshot / Kimi (native)",
    ...
    openAiCompatible: true,
    keyRequired: true,
    note: "Direct escape hatch for Kimi K3 (OpenAI-compatible). International endpoint; the .cn base (api.moonshot.cn) can be set by editing this preset's baseUrl.",
  },
];
