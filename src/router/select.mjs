...
export const ROUTING_RULES = {
  "dispatch-builder": {
    preferTier: "local",
    fallbackChain: ["ollama", "jarvis", "vllm", "llamacpp", "llama-swap", "lmstudio", "openai-compatible", "anthropic", "openai", "fugu", "openrouter", "moonshot", "together", "cursor", "codex"],
  ...
  explore: {
    preferTier: "local",
    fallbackChain: ["ollama", "jarvis", "vllm", "llama-swap", "lmstudio", "anthropic", "openai", "openrouter", "moonshot", "together"],
    defaultModels: { ollama: "llama3.1" },
    rationale: "Read-only exploration; local sufficient for map-the-territory work.",
  },
  "reviewer-security": {
    preferTier: "cloud",
    fallbackChain: ["anthropic", "openai", "fugu", "openrouter", "moonshot", "together", "jarvis", "ollama"],
  ...
  "inline-edit": {
    preferTier: "local",
    fallbackChain: ["ollama", "jarvis", "vllm", "llama-swap", "lmstudio", "anthropic", "openrouter", "moonshot", "together"],
  ...
  research: {
    preferTier: "auto",
    fallbackChain: ["openai", "fugu", "anthropic", "openrouter", "moonshot", "together", "jarvis", "ollama"],
  ...
  integrate: {
    preferTier: "cloud",
    fallbackChain: ["anthropic", "openai", "fugu", "openrouter", "moonshot", "together", "jarvis", "ollama", "vllm"],
    defaultModels: { anthropic: "claude-sonnet-4-20250514", jarvis: "llama3.1:70b-instruct-q4_K_M" },
