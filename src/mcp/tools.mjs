  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        outcome: { type: "string", description: "Outcome tag for cost-per-outcome telemetry (default round-closed)." },
        tokensIn: { type: "number", description: "Input tokens the round spent (optional)." },
        tokensOut: { type: "number", description: "Output tokens the round produced (optional)." },
      },
