...
|-----|----------|---------|
| [MODEL-ROUTER.md](./MODEL-ROUTER.md) | Operator + dispatch | Router schema, task kinds, probe/select workflow |
...
| [router.json.example](./router.json.example) | Operator | Sample `.cto-brain/router.json` |
